...
from sean.serializers import ItemSerializer, ItemListSerializer, ItemEmotionSerializer, ItemRecommendSerializer
...
class ItemHandleViewSet(LoggingMixin, ViewSet):
    ...
    def list(self, request):
        data = Item.objects.filter(role=self.request.user.role)
    ...
    def create(self, request):
        ...
        data = {
            ...
            'item_answer': request_data.get('item_answer'),
