...
class Account(AbstractBaseUser):
    ...
    #role = models.ForeignKey(Org_Roles, on_delete=models.CASCADE, blank = True, related_name='userorg1')
    role = models.ForeignKey(Org_Roles, on_delete=models.CASCADE, default = 3, related_name='userorg1')
